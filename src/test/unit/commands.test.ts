...
describe('指令系统集成测试', () => {
    ...
    describe('CommandDispatcher 路由分发', () => {
        it('应该识别并分发 Slash 指令 (/)', async () => {
            const result = await dispatcher.dispatch('/help', {} as any, {} as any, { postMessage: jest.fn() } as any, {} as any, jest.fn());
        ...
        it('应该识别并分发 At 指令 (@)', async () => {
            ...
            await dispatcher.dispatch('@file.ts', {} as any, {} as any, {} as any, {} as any, jest.fn());
        ...
        it('应该识别并分发 Shell 指令 (!)', async () => {
            ...
            await dispatcher.dispatch('!ls', {} as any, {} as any, {} as any, {} as any, jest.fn());
            expect(spy).toHaveBeenCalled();
        });
    });
